...
<main>
    <div class="col col-md-5 mx-auto">
        <form action="" method="post">
            ...
            <?php $extras = session('user_extras') ?? []; $ux = $extras[$user['id']] ?? null; ?>
            <div class="form-group mb-2">
                <label class="form-label">ID Number</label>
                <input type="text" class="form-control" readonly value="<?= $ux['id_number'] ?? '' ?>">
            </div>
            <div class="form-group mb-2">
                <label class="form-label">Role</label>
                <input type="text" class="form-control" readonly value="<?= isset($ux['role']) ? ucfirst($ux['role']) : '' ?>">
            </div>
